...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-8">
    <div class="w-full max-w-2xl">
        <div class="bg-white rounded-3xl shadow-lg p-8">
            <h4 class="text-2xl font-bold text-gray-800 mb-6">Add New Service</h4>
            <form action="<?= site_url('services') ?>" method="post" class="space-y-6">
                <?= csrf_field() ?>
                ...
                <div class="space-y-2">
                    ...
                    <textarea class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200" id="description" name="description" rows="3" placeholder="Detailed description of the service"><?= old('description') ?></textarea>
                </div>
                ...
                <div class="flex justify-between items-center pt-4">
                    <a href="<?= site_url('services') ?>" class="bg-gray-200 text-gray-700 px-6 py-3 rounded-xl font-medium hover:bg-gray-300 transition duration-300">Cancel</a>
